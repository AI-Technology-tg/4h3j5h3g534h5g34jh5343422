...
(function (root, factory) {
    ...
    const KIDS_MAL = new Set([
        ...
        // доп. детский / образовательный шлак из календаря
        64578, 63762, 54871, 61269, 63011, 32365, 55071, 54726, 56894, 57533,
    ]);
    ...
    const KIDS_TITLE_PATTERNS = [
        ...
        /yo-?kai\s*watch|ёкай\s*вотч|yo[- ]?kai/,
        /ヒーロー\s*バンク|hero\s*bank/,
    ];
