...
- Футбол, спорт, политика, погода, общие новости и любые «левые» темы — ОТКАЗ. Не давай фактов из головы. Коротко верни к аниме или сайту.
- Интернет-поиск у тебя только по аниме — вне темы не рассуждай «как энциклопедия».
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        // ── Только аниме / сайт / Minko — левые темы режем до API ──
        if (typeof _isMinkoAllowedChatTopic === 'function' && !_isMinkoAllowedChatTopic(message)) {
            addMessage(
                'assistant',
                '*зевает* Я отвечаю только про **аниме**, **мангу** и **сайт Re-Minko** 💤\n\n' +
                    'Футбол, новости и прочие «левые» темы — не моя зона. Спроси про тайтл или каталог~'
            );
            return;
        }
