...
const MINKO_CHAT_OFFLINE_PLACEHOLDERS = [
    ...
    'Лови грызуна проводов',
    'Держите его особняком Розуэлла',
    ...
    'Подушка уже греется — Дубина, выходи',
    'Прячет провода под кроватью… нашла',
    'Дубина орёт: «это не я, это кот»',
    'Дубина, я тебя вижу за роутером',
    'Беги, Дубина, беги… поздно',
    'Розетка ждёт, а я уже злая',
    'Дубина сдавайся, подушка не шутит',
    'Провода или подушка — выбирай быстро',
    'Хватит прятаться — розетка не кусается… я кусаюсь',
    'Минус провода, плюс мотив ударить подушкой',
    'Связала шнуром — жди суда',
    'Дубина оставил записку: «провода вкусные»',
    'Создатель спрятался в 404'
];
...
- Розыгрыш завершён: итоги во вкладке Инфо → «Розыгрыш» (благодарность участникам и победители). Кнопка [[nav:giveaway|Розыгрыш]]. Не предлагай участвовать заново.
